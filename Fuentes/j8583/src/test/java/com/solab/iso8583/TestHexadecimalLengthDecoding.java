...
public class TestHexadecimalLengthDecoding {
    ...
    public void shouldParseLengthWithHexadecimalDecoding() throws IOException, ParseException {
        ...
        Assertions.assertEquals("01234567890123456789012345", m.getField(3).toString());
        Assertions.assertEquals("C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0", m.getField(4).toString());
        Assertions.assertEquals(repeat("5", 274), m.getField(5).toString());
        Assertions.assertEquals(repeat("C1", 274), m.getField(6).toString());
        Assertions.assertEquals(repeat("6", 4370), m.getField(7).toString());
        Assertions.assertEquals(repeat("C2", 4370), m.getField(8).toString());
        Assertions.assertEquals("88888888", m.getField(9).toString());
        Assertions.assertEquals(repeat("C0", 255), m.getField(10).toString());
        Assertions.assertEquals(repeat("5", 4094), m.getField(11).toString());
        Assertions.assertEquals(repeat("C1", 4095), m.getField(12).toString());
        Assertions.assertEquals(repeat("6", 64188), m.getField(13).toString());
        Assertions.assertEquals(repeat("C2", 65535), m.getField(14).toString());
    }
    ...
    public void shouldWriteLengthWithHexadecimalDecoding() throws IOException {
        ...
        for (Object[] input : inputs) {
            ...
            String result = getResultAsString(isoValue, hexa);
            Assertions.assertEquals(hexaLen + value, result);
        }
    }
    ...
    public void shouldWriteCustomBinFieldLengthWithHexadecimalDecoding() throws IOException, ParseException  {
        ...
        // Then
        Assertions.assertEquals(input, HexCodec.hexEncode(serializedMessage, 0, serializedMessage.length));
    }

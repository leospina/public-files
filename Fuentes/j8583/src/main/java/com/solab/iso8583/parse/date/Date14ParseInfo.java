    ...
    public Date14ParseInfo() {
   	...
   	public <T> IsoValue<Date> parse(final int field, final byte[] buf,
        ...
        if (forceStringDecoding) {
            ...
            cal.set(Calendar.MONTH, Integer.parseInt(new String(buf, pos |+ 4, 2, getCharacterEncoding()), 10)-1);
            cal.set(Calendar.DATE, Integer.parseInt(new String(buf, pos + 6, 2, getCharacterEncoding()), 10));
            cal.set(Calendar.HOUR_OF_DAY, Integer.parseInt(new String(buf, pos + 8, 2, getCharacterEncoding()), 10));
            cal.set(Calendar.MINUTE, Integer.parseInt(new String(buf, pos + 10, 2, getCharacterEncoding()), 10));
            cal.set(Calendar.SECOND, Integer.parseInt(new String(buf, pos + 12, 2, getCharacterEncoding()), 10));
        } else {
